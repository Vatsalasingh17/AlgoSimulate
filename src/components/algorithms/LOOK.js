...
import './AlgorithmStyles.css'; // Make sure CSS has animation styles
...
const LOOK = () => {
  ...
  const handleSimulate = () => {
    ...
    let left = queue.filter(request => request < headStart).reverse();
