...
const CSCAN = () => {
  ...
  const [diskSize, setDiskSize] = useState(199); // Default max disk size
  ...
  const handleSimulate = () => {
    ...
    // C-SCAN moves in one direction until the end, then jumps to the beginning
    sequence = [...right, diskSize, 0, ...left];
